...
export class PhysicalExamComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.physicalExamForm = this.fb.group({
      ...
      LeftEyeVision: ['', Validators.required],
      LeftEyeVisionProblem: [''],
      RightEyeVision: ['', Validators.required],
      RightEyeVisionProblem: [''],
      LeftFieldVision: ['', Validators.required],
      LeftFieldVisionProblem: [''],
      RightFieldVision: ['', Validators.required],
      RightFieldVisionProblem: [''],
      LeftColorVision: ['', Validators.required],
      LeftColorVisionProblem: [''],
      RightColorVision: ['', Validators.required],
      RightColorVisionProblem: [''],
      LeftFundoscopy: ['', Validators.required],
      LeftFundoscopyProblem: [''],
      RightFundoscopy: ['', Validators.required],
      RightFundoscopyProblem: [''],
      LeftEarCanal: ['', Validators.required],
      LeftEarCanalProblem: [''],
      RightEarCanal: ['', Validators.required],
      RightEarCanalProblem: [''],
      LeftEarDrum: ['', Validators.required],
      LeftEarDrumProblem: [''],
      RightEarDrum: ['', Validators.required],
      RightEarDrumProblem: [''],
      LeftAirConduction: ['', Validators.required],
      LeftAirConductionProblem: [''],
      RightAirConduction: ['', Validators.required],
      RightAirConductionProblem: [''],
      LeftBoneConduction: ['', Validators.required],
      LeftBoneConductionProblem: [''],
      RightBoneConduction: ['', Validators.required],
      ...
      SkinProblem: [''],
      Lymphatics: ['', Validators.required],
      LymphaticsProblem: [''],
      VericoseVein: ['', Validators.required],
      VericoseVeinProblem: [''],
      CNSOrientation: ['', Validators.required],
      CNSOrientationProblem: [''],
      CNSPlacePerson: ['', Validators.required],
      CNSPlacePersonProblem: [''],
      CNSOther: ['', Validators.required],
      CNSOtherProblem: [''],
      CVSdrnm: ['', Validators.required],
      CVSdrnmProblem: [''],
      CVSOther: ['', Validators.required],
      CVSOtherProblem: [''],
